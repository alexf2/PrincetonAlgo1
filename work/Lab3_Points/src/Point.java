...
public class Point implements Comparable<Point> {
    ...
    private final class PointsComparator implements Comparator<Point> {
        @Override
        public int compare(final Point x, final Point y) 
        {
            double s1 = slopeTo(x);
            double s2 = slopeTo(y);
    ...
    private static int cmp(final double v1, final double v2)
    {
